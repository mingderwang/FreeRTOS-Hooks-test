...
const osThreadAttr_t print_idle_attributes = { .name = "print_idle", .priority =
...
const osSemaphoreAttr_t printfBinarySem01_attributes = { .name =
		"printfBinarySem01" };
...
int main(void) {
	...
	printfBinarySem01Handle = osSemaphoreNew(1, 1,
			&printfBinarySem01_attributes);
